...
import { Clock, ArrowLeft, CheckCircle, AlertCircle, Loader, BookOpen, MessageCircle, Mail } from 'lucide-react';
import { readingApi, ReadingTask1 as ReadingTask1Type } from '../services/api';
import ReactMarkdown from 'react-markdown';
import remarkGfm from 'remark-gfm';

interface ReadingTask1Props {
...
const ReadingTask1: React.FC<ReadingTask1Props> = ({ onBackToDashboard }) => {
  const [task, setTask] = useState<ReadingTask1Type | null>(null);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);
  // Remove currentQuestionIndex since we'll show all questions at once
  const [userAnswers, setUserAnswers] = useState<UserAnswers>({});
  const [timeRemaining, setTimeRemaining] = useState(11 * 60); // 11 minutes in seconds
  ...
  const loadTask = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await readingApi.generateTask1();
  ...
  const getEmailQuestions = () => {
    return task?.questions.slice(0, 6) || [];
  };

  const getReplyQuestions = () => {
    return task?.questions.slice(6, 11) || [];
  };
    ...
    return (
      <div className="min-h-screen celpip-gradient-bg flex items-center justify-center">
        <div className="celpip-card p-8 text-center animate-fade-in max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-3">Loading Reading Task 1</h2>
          <p className="text-gray-600 leading-relaxed">Generating your personalized CELPIP reading test with authentic Canadian content</p>
      ...
      <div className="min-h-screen celpip-gradient-bg flex items-center justify-center">
        <div className="celpip-card p-8 text-center max-w-md animate-fade-in">
          ...
          <div className="space-y-3">
            <button
              onClick={loadTask}
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              Try Again
            </button>
            <button
  ...
  const emailQuestions = getEmailQuestions();
  const replyQuestions = getReplyQuestions();
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="celpip-card p-8 animate-fade-in">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">Your CELPIP Reading Task 1 Results</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 transform hover:scale-105 transition-all">
                ...
                <h3 className="text-3xl font-bold text-blue-600 mb-1">{score.correct}/{score.total}</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200 transform hover:scale-105 transition-all">
                ...
                <h3 className="text-3xl font-bold text-purple-600 mb-1">{task.difficulty_level}</h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button
                onClick={loadTask}
                className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
              >
                Try Another Task
              </button>
              <button
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-4 sm:space-x-6">
              ...
              <div className="flex items-center">
                ...
                <h1 className="text-2xl font-bold text-gray-800">CELPIP Reading Task 1</h1>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 sm:space-x-6">
              ...
              <div className="bg-blue-50 px-3 sm:px-4 py-2 rounded-lg border border-blue-200">
                ...
                <p className="text-xs text-blue-600 text-center">Answered</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="prose max-w-none">
              ...
              <div className="mb-6">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-blue-800">Original Email</h3>
                </div>
                <div className="text-gray-700 leading-relaxed text-base md:text-lg bg-gray-50 p-4 md:p-6 rounded-lg border-l-4 border-blue-400 text-left overflow-y-auto markdown-content">
              ...
              <div>
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-purple-800">Your Reply</h3>
                </div>
                <div className="text-gray-700 leading-relaxed text-base md:text-lg bg-purple-50 p-4 md:p-6 rounded-lg border-l-4 border-purple-400 text-left overflow-y-auto markdown-content">
                  <ReactMarkdown remarkPlugins={[remarkGfm]}>
                    {task.reply_passage.content}
                  </ReactMarkdown>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6">
              <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400 mb-6">
                ...
                <p className="text-sm text-blue-700">
                  Answer all questions about the email content and complete the reply using the dropdowns.
                </p>
              </div>
              ...
              <div className="space-y-6 max-h-[600px] overflow-y-auto">
                ...
                <div className="border-2 border-green-200 rounded-lg p-4 bg-green-50">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-bold text-green-800">Email Questions (1-6)</h3>
                  </div>
                  
                  <div className="space-y-3">
                    {emailQuestions.map((question, index) => (
                      <div key={question.question_id} className="border border-green-300 rounded-lg p-3 bg-white">
                        <div className="flex items-start mb-3">
                          <div className="bg-green-100 text-green-800 w-6 h-6 rounded-full flex items-center justify-center font-bold text-sm mr-3 flex-shrink-0">
                            {index + 1}
                          </div>
                ...
                {/* Reply Questions (7-11) */}
                <div className="border-2 border-purple-200 rounded-lg p-4 bg-purple-50">
                  <div className="flex items-center mb-4">
                    <div className="bg-purple-100 p-2 rounded-lg mr-3">
                      <MessageCircle className="w-5 h-5 text-purple-600" />
                    </div>
                    <h3 className="text-lg font-bold text-purple-800">Reply Questions (7-11)</h3>
                  </div>
                  
                  <div className="space-y-3">
                    {replyQuestions.map((question, index) => (
                      <div key={question.question_id} className="border border-purple-300 rounded-lg p-3 bg-white">
                        <div className="flex items-start mb-3">
