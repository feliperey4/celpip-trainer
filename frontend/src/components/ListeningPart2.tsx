...
import { listeningApi, ListeningPart2 as ListeningPart2Type } from '../services/api';
...
const ListeningPart2: React.FC<ListeningPart2Props> = ({ onBackToDashboard }) => {
  const [task, setTask] = useState<ListeningPart2Type | null>(null);
  ...
  const loadTask = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await listeningApi.generatePart2();
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto">
          ...
          <h2 className="text-xl font-bold text-center text-gray-800 mb-2">
            Generating Listening Part 2
          </h2>
          <p className="text-gray-600 text-center">
            Creating a daily life conversation for you...
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">Daily Life Conversation</p>
              </div>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-blue-700 ml-2">
                        Playing Daily Life Conversation
                      </span>
                    </div>
                  </div>
                )}
                ...
                {ttsSupported && !isPlaying && !isPaused && (
                  <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <div className="text-sm text-green-700 space-y-2">
                      <p>• Listen to the conversation carefully</p>
                      <p>• You can only listen to it ONCE</p>
                      <p>• Answer questions after the conversation</p>
                  ...
                  <div className="text-center py-12">
                    <div className="mb-6">
                      ...
                      <h3 className="text-xl font-bold text-gray-800 mb-2">
                        Listen to the Daily Life Conversation
                      </h3>
                    ...
                    {isPlaying ? (
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <p className="text-blue-800 mb-4">
                          Press play to begin the daily life conversation.
                        </p>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-bold text-gray-800">
                        Questions for Daily Life Conversation
                      </h3>
                      {ttsSupported && (
