...
import { speakingApi, SpeakingTask2 as SpeakingTask2Data, SpeakingTask2Score } from '../services/api';
...
const SpeakingTask2: React.FC<SpeakingTask2Props> = ({ onBackToDashboard }) => {
  const [task, setTask] = useState<SpeakingTask2Data | null>(null);
  ...
  // Results state
  const [score, setScore] = useState<SpeakingTask2Score | null>(null);
  ...
  const loadTask = async () => {
    try {
      ...
      const response = await speakingApi.generateTask2();
  ...
  const submitForScoring = async () => {
    ...
    try {
      ...
      const response = await speakingApi.scoreTask2(submission);
    ...
    return (
      <div className="min-h-screen celpip-gradient-bg flex items-center justify-center">
        <div className="celpip-card p-8 text-center animate-fade-in max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-3">Loading Speaking Task 2</h2>
          <p className="text-gray-600 leading-relaxed text-left">Generating your personalized CELPIP speaking test with authentic personal experience topics</p>
      ...
      <div className="min-h-screen celpip-gradient-bg flex items-center justify-center">
        <div className="celpip-card p-8 text-center max-w-md animate-fade-in">
          ...
          <div className="space-y-3">
            <button
              onClick={loadTask}
              className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              Try Again
            </button>
            <button
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="celpip-card p-8 animate-fade-in">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl font-bold text-gray-800 mb-3">Great Story!</h1>
              <p className="text-lg text-gray-600 text-left">Your CELPIP Speaking Task 2 Results</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200 transform hover:scale-105 transition-all">
                ...
                <h3 className="text-2xl font-bold text-purple-600 mb-1">{score.scores.overall_score.toFixed(1)}/12.0</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 transform hover:scale-105 transition-all">
                ...
                <h3 className="text-2xl font-bold text-blue-600 mb-1">{score.scores.content_score.toFixed(1)}/12.0</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200 transform hover:scale-105 transition-all">
                ...
                <h3 className="text-2xl font-bold text-green-600 mb-1">{score.scores.vocabulary_score.toFixed(1)}/12.0</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
              >
                Try Another Task
              </button>
              <button
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="celpip-card p-8 animate-fade-in">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 mb-2">CELPIP Speaking Task 2</h1>
              <p className="text-gray-600 text-left">Talking about a Personal Experience</p>
            </div>
            <button
              onClick={onBackToDashboard}
          ...
          {timer.isActive && (
            <div className="text-center mb-8">
              <div className={`inline-flex items-center justify-center w-32 h-32 rounded-full text-4xl font-bold ${
                timer.timeRemaining <= 10 ? 'bg-red-100 text-red-600' : 'bg-purple-100 text-purple-600'
              }`}>
          ...
          {currentPhase === 'instructions' && (
            <div className="space-y-6">
              <div className="bg-purple-50 p-6 rounded-xl border border-purple-200">
                <h3 className="text-xl font-bold text-purple-800 mb-4">{task.scenario.title}</h3>
                <div className="space-y-3 text-gray-700 text-left">
                  <p><strong>Topic:</strong> {task.scenario.topic}</p>
                  <p><strong>Context:</strong> {task.scenario.context}</p>
                  <p><strong>Experience Type:</strong> {task.scenario.experience_type}</p>
                  
                  {task.scenario.guiding_questions.length > 0 && (
                    <div>
                      <p><strong>Think about these questions:</strong></p>
                      <ul className="mt-2 space-y-1">
                        {task.scenario.guiding_questions.map((question, index) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div className="flex items-center p-3 bg-white rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-purple-600">{task.instructions.preparation_time_seconds}s</p>
                    </div>
                  </div>
                  <div className="flex items-center p-3 bg-white rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-purple-600">{task.instructions.speaking_time_seconds}s</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                {!microphoneState.hasPermission && (
                  <div className="text-center">
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 disabled:from-purple-400 disabled:to-purple-500 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 disabled:cursor-not-allowed"
                    >
                ...
                {microphoneState.hasPermission && (
                  <div className="text-center">
                    ...
                    <p className="text-purple-600 font-medium mb-4 text-left">✓ Microphone ready</p>
                    <button 
          ...
          {currentPhase === 'preparation' && (
            <div className="space-y-6">
              <div className="bg-purple-50 p-6 rounded-xl border border-purple-200">
                <h3 className="text-xl font-bold text-purple-800 mb-4">Remember the Topic</h3>
                <p className="text-lg font-medium text-gray-800 mb-2 text-left">{task.scenario.title}</p>
                <p className="text-gray-700 text-left">{task.scenario.topic}</p>
              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700 text-left">A specific personal experience related to this topic</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700 text-left">When and where this experience happened</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700 text-left">Why this experience was meaningful to you</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                    <span className="text-gray-700 text-left">How to organize your story chronologically</span>
                  </li>
                </ul>
              </div>
          ...
          {currentPhase === 'speaking' && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-left">Share your personal experience story</p>
              </div>

              <div className="bg-purple-50 p-6 rounded-xl border border-purple-200">
                <h3 className="text-xl font-bold text-purple-800 mb-2">{task.scenario.title}</h3>
                <p className="text-gray-700 text-left">{task.scenario.topic}</p>
              </div>
          ...
          {currentPhase === 'review' && (
            <div className="space-y-6">
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-32 h-32 bg-purple-100 rounded-full mb-4">
              ...
              <div className="text-center space-y-4">
                <button 
                  ...
                  className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 disabled:opacity-50"
                >
                  {submissionLoading ? (
                    <>
